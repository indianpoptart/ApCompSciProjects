package com.nikhilparanjape.rpsChecker;
...
public class WebChecker extends Object
{
	public static void main(String args[]){
		try{
			...
			try {
				while (true) {
					String schoolList[] = { "Ridgefield High", "Branchville", "East Ridge", "Scotts Ridge", "Scotland", "Ridgefield Public Schools"};
					connection.connect();
					...
					else if(res.contains("<!-- subsite emergency announcement empty -->")){
					...
					else if(res.contains("early dismissal")){
						final StringBuilder b = new StringBuilder();
					    String separator = "";
					    for (final String names: schoolList) {
					        b.append(separator);
					        b.append(Pattern.quote(names));
					        separator = "|";
					    }
					    String result = b.toString();
					    if(result.equalsIgnoreCase("Early Dismissal")){
					    	JOptionPane.showMessageDialog(null, result + "has an early dismissal", "Ridgefield Public Schools", JOptionPane.INFORMATION_MESSAGE, icon);
					    }
					    else if(!result.equalsIgnoreCase("Ridgefield Public Schools")){
					    	JOptionPane.showMessageDialog(null, "All schools on early dismissal schedule", "Ridgefield Public Schools", JOptionPane.INFORMATION_MESSAGE, icon);
					    }
					    else{
					    	JOptionPane.showMessageDialog(null, "Unknown school has an early dismissal", "Ridgefield Public Schools", JOptionPane.INFORMATION_MESSAGE, icon);
					    }
			...
			JOptionPane.showMessageDialog(null, "An error has occured!" + e, "ERROR!", JOptionPane.ERROR_MESSAGE);
		}
	}
}